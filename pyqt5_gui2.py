...
class MainWindow(QMainWindow):
    ...
    def UI(self):
        ...
        #################################
        ## Info ######################
        text = QLabel("This software is made for increasing business acounts' activities on the \nsocial media Instagram. The program is "
        ...
        textStrong = QLabel("The founder of this software takes no responsibility \nfor blocking your account on instagram", self)
